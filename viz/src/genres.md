...
Та же совместная встречаемость, но в виде сети: размер узла — частота тега, толщина связи — насколько чаще, чем случайно, эти два тега встречаются вместе. Показаны только несколько самых сильных связей на тег — иначе сеть из самых частых тегов превращается в сплошной клубок, ведь популярные теги в той или иной мере пересекаются почти со всеми.
